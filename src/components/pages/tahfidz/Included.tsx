               ...
               <div className="tg-tour-about-list  tg-tour-about-list-2">
                  <ul>
                     <li>
                        ...
                        <span className="text">Muroja‘ah wa Ziyādah (metode Sabaq, Sabqī, Manzil)</span>
                     </li>
                     <li>
                        <span className="icon mr-10"><i className="fa-sharp fa-solid fa-check fa-fw"></i></span>
                        <span className="text">Taḥsīn al-Qirā’ah</span>
                     </li>
                     <li>
                        <span className="icon mr-10"><i className="fa-sharp fa-solid fa-check fa-fw"></i></span>
                        <span className="text">Tadabbur Alam</span>
                     </li>
                     <li>
                        <span className="icon mr-10"><i className="fa-sharp fa-solid fa-check fa-fw"></i></span>
                        <span className="text">'Ard al-qudrāt islamiyah</span>
                     </li>
                  </ul>
               </div>
            </div>
            <div className="col-lg-7 col-11 m-auto m-lg-0">
               <div className="tg-tour-about-list tg-tour-about-list-2">
                  <ul>
                     <li>
                        <span className="icon mr-10"><i className="fa-sharp fa-solid fa-check fa-fw"></i></span>
                        <span className="text">Dauroh Tahfidz</span>
                     </li>
                     <li>
                        <span className="icon mr-10"><i className="fa-sharp fa-solid fa-check fa-fw"></i></span>
                        <span className="text">Munāqasyah wa Tasmi‘</span>
                     </li>
                     <li>
                        <span className="icon mr-10"><i className="fa-sharp fa-solid fa-check fa-fw"></i></span>
