...
const Banner = () => {
	return (
		<div className="tg-hero-area fix p-relative">
						...
						<div className="row justify-content-center">
							<div className="col-xl-10">
								<div className="tg-hero-content text-center">
									<div className="tg-hero-title-box pt-lg-70 pt-0 mb-10">
										<h1 className="tg-hero-title wow fadeInUp" data-wow-delay=".4s" data-wow-duration=".9s"><b>SPEMDUTA</b></h1>
										<h5 className="tg-hero-subtitle mb-5 wow fadeInUp" data-wow-delay=".3s" data-wow-duration=".7s">SMP MUHAMMADIYAH 2 TAMAN</h5>
									</div>
									<div className="tg-hero-price-wrap mb-10 d-flex align-items-center justify-content-center  wow fadeInUp" data-wow-delay=".7s" data-wow-duration="1.3s">
										<p className="mr-15"><i>"The Humanistic and Futuristic School"</i></p>
									</div>
									{/* <div className="tg-hero-title-box mb-35 d-none d-lg-block">
										<p className="tg-hero-subtitle mb-5 wow fadeInUp" data-wow-delay=".3s" data-wow-duration=".7s">Dengan visi Sekolah Islam yang Humanis dan Futuris, SMP Muhammadiyah 2 Taman berkomitmen memberikan pendidikan komprehensif dengan berlandaskan nilai islami guna menghasilkan lulusan yang unggul dalam Imtaq dan Ipteks.</p>
									</div> */}
									<div className="tg-hero-btn-box pt-20 wow fadeInUp" data-wow-delay=".8s" data-wow-duration="1.5s">
										<Link target='_blank' to="https://smpmduta-ppdb.madinapay.id" style={{ backgroundColor: "#006cff", borderColor: "#006cff", color: "#fff" }} className="tg-btn tg-btn-switch-animation">
			...
			<div className="tg-hero-bottom-shape-2 d-none d-md-block fadeout">
				<span>
