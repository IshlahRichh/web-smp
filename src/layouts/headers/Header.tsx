                  ...
                  <div className="row align-items-center">
                     <div className="col-lg-9 col-5">
                        <div className="tgmenu__wrap d-flex align-items-center">
                           <div className="offCanvas__logo responsive-logo-padding">
                              <Link className="logo-1" to="/"><img src="/assets/img/logo/logo-white.png" alt="Logo" /></Link>
                              <Link className="logo-2 d-none" to="/"><img src="/assets/img/logo/logo-blue.png" alt="Logo" /></Link>
                           </div>
                        ...
                        <div className="tg-menu-right-action d-flex align-items-center justify-content-end">
                           <div className="tg-header-contact-info d-flex align-items-center">
                              ...
                              <div className="tg-header-contact-number d-none d-xl-block">
                                 <span>WhatsApp:</span>
                                 <Link to="https://api.whatsapp.com/send?phone=6281232331554&text=Assalamualaikum,%20Saya%20ingin%20bertanya%20tentang%20PPDB%20SPEMDUTA.">+62 812 3233 1554</Link>
                              </div>
                           </div>
